use adss_contract::{
    AgentPollRequest, AgentPollResponse, AgentReportRequest, AgentReportResponse, DesiredState,
    DomainConfig, DriftReportRequest, Group, OrgUnit, PasswordChangeRequest,
