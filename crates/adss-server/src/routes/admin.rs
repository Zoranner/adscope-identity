use adss_contract::{Group, OrganizationalUnit, PasswordChangeResponse, User, UserStatus};
...
use crate::{
    auth::{agent_key_hash, constant_time_eq},
    error::ApiError,
    state::AppState,
};
...
async fn create_domain(
    ...
    let domain = state
        ...
        .upsert_domain(DomainRecord {
            ...
            agent_key_hash: agent_key_hash(&request.agent_key),
